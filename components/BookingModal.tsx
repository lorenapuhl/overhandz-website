      ...
      <div className="px-6 py-6">
        ...
        <AnimatePresence mode="wait">
          ...
          {step === 1 && selectedClass && (
            ...
            >
              <p className="text-dim text-sm mb-4">{dict.you_are_booking}</p>
              ...
              <div className="bg-canvas border border-edge rounded-lg p-4 mb-6 space-y-2">
                ...
                <p className="text-dim text-sm">{selectedClass.coach}</p>
                <p className="text-dim text-sm">
                  {selectedClass.durationMinutes} min · {selectedClass.type}
                </p>
                <p className="text-lift text-xs font-medium">
                  {selectedClass.spotsLeft === 1
                    ? `1 ${dict.spot_singular}`
                    : `${selectedClass.spotsLeft} ${dict.spot_plural}`}
                </p>
              </div>
          ...
          {step === 3 && (
            <motion.div
              ...
              className="space-y-4"
            >
              <p className="text-white font-medium mb-2">{dict.payment}</p>
